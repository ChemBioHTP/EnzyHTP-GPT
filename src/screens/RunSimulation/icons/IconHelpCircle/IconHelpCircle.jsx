...
export const IconHelpCircle = ({ className }) => {
  return (
    <svg
      className={`icon-help-circle ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_11573_7368)">
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_11573_7368">
