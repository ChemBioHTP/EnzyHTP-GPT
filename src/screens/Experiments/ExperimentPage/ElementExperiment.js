...
export const ElementExperiment = () => {
  ...
  const [sideLabelSelected, setSideLabelSelected] = useState([
    true,
    false,
    false,
    false,
  ...
  const [sideLabelState, setSideLabelState] = useState([
    "selected",
    "enabled",
    "enabled",
    "enabled",
      ...
      <div className="div-2" data-breakpoints-mode="max-max-plus-1584px-1784px">
        <Routes>
          <Route
            path="/"
            element={
              <ElementExperimentsList
                sideVisible={isVisible}
                experiments={experiments}
                createNewExp={createNewExperiment}
              />
            }
          />
          <Route
        ...
        <NavigationHeader
          className="navigation-header-instance"
          onClick={handleHeaderClick}
        />
        {logoutButton && (
          <div className="div-profile" onClick={handleSignout}>
            <Button
              buttonText="Log out"
