...
export const DataTableHeader = ({
  ...
  return (
    <div
      className={`data-table-header state-10-${state.state} size-9-${state.size} ${className}`}
      onMouseEnter={() => {
    ...
    >
      ...
      <div className="cell">
        {state.size === "extra-large" && (
          <>
            <div className="content">
              <div className="text-2">{cellText}</div>
              {["hover", "selected"].includes(state.state) && (
                <div className="icon-margin">
                  {state.sorted === "ascending" && <ArrowUp5 className="instance-node-2" />}

                  {state.sorted === "none" && <ArrowsVertical className="instance-node-2" />}

                  {state.sorted === "descending" && <ArrowDown5 className="instance-node-2" />}
                </div>
              )}
            </div>
        ...
        {["extra-small", "large", "medium", "small"].includes(state.size) && <div className="text-2">{cellText}</div>}
        ...
        {((state.size === "extra-small" && state.sorted === "ascending") ||
          ...
          (state.size === "small" && state.sorted === "ascending")) && <ArrowUp5 className="instance-node-2" />}
        ...
        {((state.size === "extra-small" && state.sorted === "none" && state.state === "hover") ||
          ...
          <ArrowsVertical className="instance-node-2" />
        )}
        ...
        {((state.size === "extra-small" && state.sorted === "descending") ||
          ...
          (state.size === "small" && state.sorted === "descending")) && <ArrowDown5 className="instance-node-2" />}
      </div>
    </div>
  );
};
