...
export const NavigationSideNavCustom = ({ version, className }) => {
  return (
    <div className={`navigation-side-nav ${version} ${className}`}>
      <div className="frame-2">
        {version === "version-4" && (
          ...
          //   type="link"
          // />
          <SideNav expanded isChildOfHeader={false}
          >
            <SideNavItems>
              <SideNavMenu title="My experiments" renderIcon={() => <IconGrid />} large>
                <SideNavMenuItem title="All"></SideNavMenuItem>
                <SideNavMenuItem title="In progress"></SideNavMenuItem>
                <SideNavMenuItem title="With error"></SideNavMenuItem>
                <SideNavMenuItem title="Complete"></SideNavMenuItem>
                <SideNavMenuItem title="Archived"></SideNavMenuItem>
              </SideNavMenu>
            </SideNavItems>
          </SideNav>
          )}
...
NavigationSideNavCustom.propTypes = {
  version: PropTypes.oneOf(["v3", "v1", "version-5", "version-4", "v2"]),
};

export default NavigationSideNavCustom;
