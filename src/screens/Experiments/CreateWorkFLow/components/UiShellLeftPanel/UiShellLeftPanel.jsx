...
export const UiShellLeftPanel = ({
  ...
  return (
    <div
      className={`UI-shell-left-panel state-9-${state.state} divider-${state.divider} compact-${state.compact} ${state.level} selected-2-${state.selected} ${state.type} ${className}`}
      onMouseLeave={() => {
