...
export const Button = ({
  ...
  divClassName,
  iconClassName,
  icon1 = <Add className="add-56" color="white" />,
}) => {
      ...
      {((state.size === "expressive" && state.state === "hover") ||
        ...
        <div className="button-content">
          {(state.style === "danger-primary" ||
            ...
            <div className={`text-wrapper-2 ${divClassName}`}>{buttonText}</div>
          )}
          ...
          {(state.style === "danger-ghost" || (state.style === "ghost" && state.type === "text-icon")) && (
      ...
      {state.style === "danger-primary" && state.state === "hover" && state.size === "medium" && (
        <>
          <button className="button-wrapper">
            <div className="text-wrapper-4">{buttonText}</div>
          </button>
