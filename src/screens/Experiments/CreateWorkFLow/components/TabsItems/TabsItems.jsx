...
export const TabsItems = ({
  ...
  return (
    <div
      className={`tabs-items state-4-${state.state} ${state.style} type-1-${state.type} ${state.alignment} selected-${state.selected} size-4-${state.size} ${className}`}
      onMouseEnter={() => {
