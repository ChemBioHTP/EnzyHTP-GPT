...
import { TooltipCaretItem14 } from "../../icons/TooltipCaretItem14";
import { TooltipCaretItem15 } from "../../icons/TooltipCaretItem15";
import { TooltipCaretItem18 } from "../../icons/TooltipCaretItem18";
import { TooltipCaretItem2 } from "../../icons/TooltipCaretItem2";
import { TooltipCaretItem21 } from "../../icons/TooltipCaretItem21";
import { TooltipCaretItem3 } from "../../icons/TooltipCaretItem3";
...
export const TooltipItem = ({ tooltipText = "Tooltip text", type, position, alignment, className }) => {
  return (
    <div className={`tooltip-item ${type} ${position} ${alignment} ${className}`}>
      {position === "bottom" && type === "icon" && <TooltipCaretItem18 className="tooltip-caret-item" />}
      ...
      {position === "left" && type === "icon" && <TooltipCaretItem15 className="tooltip-caret-item-2" />}

      {type === "icon" && position === "right" && (
        <>
          <TooltipCaretItem14 className="tooltip-caret-item" />
      ...
      {alignment === "center" && position === "top" && ["definition", "standard"].includes(type) && (
        <TooltipCaretItem7 className="tooltip-caret-item-2" />
      )}
      ...
      {position === "bottom" && ["definition", "standard"].includes(type) && (
        <>
          <TooltipCaretItem4 className="tooltip-caret-item" />
      ...
      {type === "standard" && position === "right" && (
        <>
          <TooltipCaretItem3 className="tooltip-caret-item" />
      ...
      {type === "standard" && position === "left" && <TooltipCaretItem2 className="tooltip-caret-item-2" />}

      {position === "top" && type === "icon" && <TooltipCaretItem21 className="tooltip-caret-item-2" />}
    </div>
  );
};
