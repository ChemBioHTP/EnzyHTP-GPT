...
export const CheckboxCheckedFilled8 = ({ opacity = "unset", fillOpacity = "unset", className }) => {
  return (
    <svg
      className={`checkbox-checked-filled-8 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
...
CheckboxCheckedFilled8.propTypes = {
