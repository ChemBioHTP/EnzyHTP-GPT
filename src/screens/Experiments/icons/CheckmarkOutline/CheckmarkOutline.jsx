...
export const CheckmarkOutline = ({ opacity = "unset", color = "#0F62FE", className }) => {
  return (
    <svg
      className={`checkmark-outline ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
