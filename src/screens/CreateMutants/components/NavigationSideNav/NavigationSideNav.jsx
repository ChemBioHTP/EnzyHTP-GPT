    ...
    <div className={`navigation-side-nav ${version} ${className}`}>
          ...
          {["v2", "v3", "version-5"].includes(version) && (
            <>
              ...
              <UiShellLeftPanel
                ...
                level="level-2"
                linkText="All"
                selected={version === "v3" ? true : UIShellLeftPanelSelected}
                stateProp={version === "v3" ? "selected" : UIShellLeftPanelStateProp}
                type="link"
              />
              <UiShellLeftPanel
                className="UI-shell-left-panel-menu-item"
      ...
      <div className="frame-9">
        {["v1", "v2", "v3", "version-4"].includes(version) && (
          <>
            <UiShellLeftPanel
              className={`${["v1", "version-4"].includes(version) ? "UI-shell-left-panel-menu-item" : "class-2"}`}
              compact={false}
              divider={false}
              expanded={false}
              level="level-1"
