...
export const AminoAcidTable = ({ originalSequence, mutations }) => {
  return (
      ...
      <Table>
        <TableHead>
          <TableRow>
            ...
            <TableCell>Mutants</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {mutations.map((mutation) => (
            <TableRow key={mutation.seqnum}>
              <TableCell>{mutation.seqnum}</TableCell>
              <TableCell>{originalSequence[mutation.seqnum - 1]}</TableCell>
              <TableCell>{mutation.mutantAminoAcid}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
