...
export const IconHelpCircle5 = ({ className }) => {
  return (
    ...
    >
      <g className="g" clipPath="url(#clip0_11573_4935)">
        ...
        <path
          ...
          strokeLinejoin="round"
        />
        <path className="path" d="M8 11.3335H8.00667" stroke="black" strokeLinecap="round" strokeLinejoin="round" />
      </g>
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_11573_4935">
