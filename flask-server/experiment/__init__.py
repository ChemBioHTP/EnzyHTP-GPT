...
experiment_api.add_resource(views.ThirdPartySoftwareAuthorizationReviewApi, "/third-party-software/authorization/review")
experiment_api.add_resource(views.ThirdPartySoftwareAuthorizationDocumentApi, "/third-party-software/authorization/review/document")
...
experiment_api.add_resource(views.SlurmAccreDeployApi, "/<experiment_id>/deploy/accre")
