import { x as et, f as ee, O as tt } from "./index-CZcGtnfm.js";
function _e(e, t) {
  return function () {
...
const ot = X("string"),
  ...
  pt = P("URLSearchParams"),
  [ht, mt, yt, wt] = ["ReadableStream", "Request", "Response", "Headers"].map(
    P
  ),
  bt = (e) =>
...
const jt = (e) => {
  ...
  qt = P("AsyncFunction"),
  It = (e) => e && (G(e) || x(e)) && x(e.then) && x(e.catch),
  je = ((e, t) =>
    e
      ? setImmediate
      : t
...
function Q(e, t, n) {
  ...
  function l(p, y, h) {
    ...
    return ie(p) ? !0 : (t.append(be(h, y, o), u(p)), !1);
  }
  const d = [],
    w = Object.assign(Jt, {
      defaultVisitor: l,
  ...
  function R(p, y) {
    if (!a.isUndefined(p)) {
      ...
      d.push(p),
        a.forEach(p, function (b, g) {
          (!(a.isUndefined(b) || b === null) &&
            s.call(t, b, a.isString(g) ? g.trim() : g, y, w)) === !0 &&
            R(b, y ? y.concat(g) : [g]);
        }),
        d.pop();
    }
...
function ze(e, t, n) {
  ...
  if (
    (s
      ? (o = s(t, n))
      : (o = a.isURLSearchParams(t) ? t.toString() : new de(t, n).toString(r)),
    o)
  ) {
    const i = e.indexOf("#");
    i !== -1 && (e = e.slice(0, i)),
...
const Je = {
  ...
  $t = typeof URLSearchParams < "u" ? URLSearchParams : de,
  Wt = typeof FormData < "u" ? FormData : null,
  vt = typeof Blob < "u" ? Blob : null,
  Kt = {
    isBrowser: !0,
    classes: { URLSearchParams: $t, FormData: Wt, Blob: vt },
  ...
  Qt = (pe && window.location.href) || "http://localhost",
  Zt = Object.freeze(
    ...
    return (
      ...
      f
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = tn(s[i])),
          !c)
    );
  }
...
function D(e, t) {
  ...
  function s(u, l, d, w) {
    if (a.isUndefined(l)) {
      if (!a.isUndefined(u)) return r(void 0, u, d, w);
...
const Ke = (e) => {
    ...
    (t.headers = i = A.from(i)),
      (t.url = ze(ve(t.baseURL, t.url), e.params, e.paramsSerializer)),
      c &&
        i.set(
          "Authorization",
          "Basic " +
    ...
    if (
      ...
      (r && a.isFunction(r) && (r = r(t)), r || (r !== !1 && pn(t.url)))
    ) {
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        "onloadend" in h
          ...
          u && (([w, p] = W(u, !0)), h.addEventListener("progress", w)),
          f &&
            h.upload &&
            (([d, R] = W(f)),
  ...
  gn = async function* (e, t) {
    for await (const n of Sn(e)) yield* Rn(n, t);
  },
  Sn = async function* (e) {
  ...
  Xe = Z && typeof ReadableStream == "function",
  Tn =
    Z &&
  ...
  xe = 64 * 1024,
  ce = Xe && Ge(() => a.isReadableStream(new Response("").body)),
  v = { stream: ce && ((e) => e.body) };
Z &&
  ((e) => {
...
const An = async (e) => {
  ...
  Pn =
    ...
    (async (e) => {
      ...
      let R = En([s, o && o.toAbortSignal()], i),
        p;
      const y =
        R &&
        R.unsubscribe &&
      ...
      try {
        ...
        let g = await fetch(p);
        const S = ce && (u === "stream" || u === "response");
        if (ce && (c || (S && y))) {
          const O = {};
        ...
        u = u || "text";
        let N = await v[a.findKey(v, u) || "text"](g, e);
        return (
          !S && y && y(),
  ...
  Qe = {
    getAdapter: (e) => {
      ...
      for (let o = 0; o < t; o++) {
        ...
        if (
          ((r = n),
          !Cn(n) && ((r = ue[(i = String(n)).toLowerCase()]), r === void 0))
        )
...
function Ce(e) {
  return (
    ...
    Qe.getAdapter(e.adapter || M.adapter)(e).then(
      function (r) {
        return (
          se(e),
...
const $ = { assertOptions: Nn, validators: Y },
  C = $.validators;
class B {
  constructor(t) {
    (this.defaults = t),
...
E.HttpStatusCode = le;
E.default = E;
const j = E.create({ timeout: 1e3 * 60 * 5, baseURL: "" });
j.interceptors.request.use(
  (e) => (
    (e.headers.Authorization = et() || ""),
    (e.headers["Content-Type"] = "application/x-www-form-urlencoded"),
    e.method === "get" && (e.params = { ...e.params, t: new Date().getTime() }),
    e.url.includes("pur/contract/export") && (e.headers.responseType = "blob"),
    e.method === "put" && (e.headers["Content-Type"] = "multipart/form-data"),
    e
  ),
  (e) => Promise.reject(e)
);
j.interceptors.response.use(
  (e) =>
    e.status == 200 || e.status == 201
      ...
      : (ee.error(e.data.message ?? "未知错误"),
        Promise.reject(e.data.message)),
  (e) => {
    var t;
    if (e.response) {
      let n =
        ((t = e.response.data) == null ? void 0 : t.message) ??
        e.response.status + " " + e.response.statusText;
      return (
        ee.error(n),
        e.response.status === 401 && tt.push({ path: "/login" }),
        Promise.resolve(e.response.data)
      );
    } else
      return (
        ee.error("请求超时, 请刷新重试"),
...
const Ln = (e, t, n = {}) =>
  ...
  jn = { get: Ln, post: Bn, put: Dn, del: Un };
export { jn as a };
